...
def runstrat(args=None):
    ...
    tzinput = 'Europe/Berlin'   # 时区
    # tz = tzinput
    tz = 'US/Eastern'   # 时区
    kwargs = dict(tzinput=tzinput, tz=tz)   # 创建数据源
    ...
    if args.pandascal:
        ...
        cerebro.addcalendar(NYSE_2016())  # or NYSE_2016() to pass an instance  # 添加自定义交易日历
...
def parse_args(pargs=None):
    ...
    parser.add_argument('--data0', default='yhoo-2016-11.csv',  # 数据源
